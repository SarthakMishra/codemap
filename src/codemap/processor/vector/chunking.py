...
MAX_HIERARCHY_DEPTH = 2  # Maximum depth for hierarchy extraction
...
class TreeSitterChunker:
	...
	def __init__(self, lod_generator: LODGenerator | None = None) -> None:
		"""
	...
	def _extract_nested_entities(self, entity: LODEntity) -> list[dict[str, Any]]:
		...
		def process_nested(nested_entity: LODEntity, depth: int = 1) -> None:
			...
			# Process children (limited to MAX_HIERARCHY_DEPTH levels deep)
	...
	def _chunk_entity_recursive(
		...
		for child in entity.children:
			yield from self._chunk_entity_recursive(
				...
				if file_entity
				else (entity if entity.entity_type == EntityType.MODULE else None),
			)
