...
from codemap.processor.analysis.tree_sitter.languages.base import LanguageConfig
from codemap.processor.analysis.tree_sitter.languages.javascript import JavaScriptSyntaxHandler
