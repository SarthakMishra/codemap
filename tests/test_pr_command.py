...
def mock_git_utils():
    """Mock git utilities."""
    with patch("codemap.cli.pr.get_current_branch") as mock_get_current_branch, \
         patch("codemap.cli.pr.get_default_branch") as mock_get_default_branch, \
         patch("codemap.cli.pr.branch_exists") as mock_branch_exists, \
         patch("codemap.cli.pr.create_branch") as mock_create_branch, \
         patch("codemap.cli.pr.checkout_branch") as mock_checkout_branch, \
         patch("codemap.cli.pr.push_branch") as mock_push_branch, \
         patch("codemap.cli.pr.get_commit_messages") as mock_get_commit_messages, \
         patch("codemap.cli.pr.create_pull_request") as mock_create_pull_request, \
         patch("codemap.cli.pr.get_existing_pr") as mock_get_existing_pr, \
         patch("codemap.cli.pr.update_pull_request") as mock_update_pull_request, \
         patch("codemap.cli.pr.validate_repo_path") as mock_validate_repo_path, \
         patch("codemap.cli.pr.GitWrapper") as mock_git_wrapper, \
         patch("codemap.cli.pr.DiffSplitter") as mock_diff_splitter, \
         patch("codemap.cli.pr.setup_message_generator") as mock_setup_message_generator, \
         patch("codemap.cli.pr.process_all_chunks") as mock_process_all_chunks, \
...
def test_pr_create_command(mock_git_utils):
