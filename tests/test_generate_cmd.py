...
class TestGenerateTreeOnly:
    ...
    def test_generate_tree_only_with_output(self, mock_console: MagicMock, tmp_path: Path) -> None:
        ...
        with patch("codemap.cli.generate_cmd.console", mock_console), patch(
            "codemap.cli.generate_cmd.MarkdownGenerator"
...
class TestWriteDocumentation:
    ...
    def test_write_documentation_success(self, mock_console: MagicMock, tmp_path: Path) -> None:
        ...
        with patch("codemap.cli.generate_cmd.console", mock_console), patch(
            "codemap.cli.generate_cmd.create_spinner_progress"
        ) as mock_progress:
            progress = MagicMock()
            task_id = "task1"
...
class TestGenerateCommand:
    ...
    def test_generate_command_tree_only(self, mock_console: MagicMock) -> None:
        ...
        with patch("codemap.cli.generate_cmd.console", mock_console), patch(
            "codemap.cli.generate_cmd.setup_logging"
    ...
    def test_generate_command_with_config_overrides(self, mock_console: MagicMock) -> None:
        ...
        with patch("codemap.cli.generate_cmd.console", mock_console), patch(
            ...
            with patch("codemap.cli.generate_cmd.CodeParser"), patch(
                "codemap.cli.generate_cmd.DocumentationProcessor"
            ), patch("codemap.cli.generate_cmd.MarkdownGenerator"), patch(
                "codemap.cli.generate_cmd.create_spinner_progress"
            ), patch("codemap.cli.generate_cmd.determine_output_path"), patch(
                "codemap.cli.generate_cmd.write_documentation"
            ):
                # Call with overrides
            ...
            with patch("codemap.cli.generate_cmd.CodeParser") as mock_parser_cls:
                ...
                with patch("codemap.cli.generate_cmd.DocumentationProcessor") as mock_processor_cls:
                    ...
                    with patch("codemap.cli.generate_cmd.MarkdownGenerator") as mock_generator_cls:
                        ...
                        with patch("codemap.cli.generate_cmd.create_spinner_progress"), patch(
                            "codemap.cli.generate_cmd.determine_output_path"
                        ) as mock_determine, patch("codemap.cli.generate_cmd.write_documentation") as mock_write:
...
class TestGenerateCommandIntegration(FileSystemTestBase, CLITestBase):
    ...
    def test_generate_tree_integration(self) -> None:
        ...
        with patch("codemap.cli.generate_cmd.Path.cwd", return_value=self.temp_dir), patch(
            "codemap.cli.generate_cmd.console"
        ):
            try:
