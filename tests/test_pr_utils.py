...
def test_generate_pr_title_from_commits_empty() -> None:
...
def test_generate_pr_title_from_commits_feat() -> None:
...
def test_generate_pr_title_from_commits_fix() -> None:
...
def test_generate_pr_title_from_commits_with_scope() -> None:
...
def test_generate_pr_title_from_commits_fallback() -> None:
...
def test_generate_pr_description_from_commits_empty() -> None:
...
def test_get_existing_pr(mock_subprocess_run: MagicMock) -> None:
    ...
    mock_list_process.stdout = json.dumps(
        {"number": 123, "title": "PR Title", "body": "PR Description", "url": "https://github.com/user/repo/pull/123"}
    )
...
def test_suggest_branch_name_empty() -> None:
...
def test_suggest_branch_name_non_conventional() -> None:
