"""Tests for semantic chunking logic in DiffSplitter."""
...
from codemap.git.diff_splitter.splitter import GitDiff
...
class TestEmbeddingSimilarity:
	...
	def test_embedding_similarity(self) -> None:
		...
		# Create a semantic strategy for testing
		semantic_strategy = SemanticSplitStrategy(embedding_model=None)

		# Mock the embedding function to return predictable values
		with patch.object(semantic_strategy, "_get_code_embedding") as mock_embedding:
			...
			# Act
			sim1_2 = semantic_strategy._calculate_semantic_similarity(code1, code2)
			sim1_3 = semantic_strategy._calculate_semantic_similarity(code1, code3)
	...
	def test_sentence_transformers_availability(self) -> None:
		...
		with patch.object(DiffSplitter, "_check_sentence_transformers_availability") as mock_check:
			...
			with patch.object(semantic_strategy, "_get_code_embedding") as mock_embedding:
				...
				with patch.object(semantic_strategy, "_calculate_semantic_similarity") as mock_sim:
