...
def test_setup_logging() -> None:
    ...
    # Test with verbose=False and no LOG_LEVEL environment variable
    ...
    with patch("logging.basicConfig") as mock_logging, patch.dict(os.environ, {"LOG_LEVEL": "ERROR"}, clear=True):
        setup_logging(is_verbose=False)
        mock_logging.assert_called_once()
